...
var MainPage = /** @class */ (function (_super) {
    ...
    MainPage.prototype.render = function () {
        ...
        switch (this.state.stepNumber) {
            default:
            case 0: return React.createElement("button", { className: "redSquare", onClick: function () { return _this.setState({ stepNumber: 1 }); } });
            case 1: return React.createElement("button", { className: "blueSquare", onClick: function () { return _this.setState({ stepNumber: 2 }); } });
            case 2: return React.createElement("button", { className: "yellowSquare", onClick: function () { return _this.setState({ stepNumber: 0 }); } });
        }
    };
    return MainPage;
}(React.Component));
